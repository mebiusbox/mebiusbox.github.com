...
void Lighting(inout ReflectedLight reflectedLight, in GeometricContext geometry, in Material material)
{
...
void main() {
  ...
  // Lighting(reflectedLight, geometry, material);
  ...
  gl_FragColor = vec4(metallic, roughness, 0.0, 1.0);
}